    ...
    public class PMXFormat
    {
        ...
        public void Reload(BinaryReader reader)
        {
            ...
            for (int i = 0; i < countOfVertex; i++)
            {
                ...
                vertex.Coordinate = ReadVector3ZInv(reader);
                vertex.Normal = ReadVector3ZInv(reader);
            ...
            for (int i = 0; i < countOfBone; i++)
            {
                ...
                bone.Position = ReadVector3ZInv(reader);
                ...
                {
                    bone.ChildOffset = ReadVector3ZInv(reader);
                }
                ...
                {
                    bone.LocalAxisX = ReadVector3ZInv(reader);
                    bone.LocalAxisZ = ReadVector3ZInv(reader);
                ...
                if (bone.Flags.HasFlag(PMX_BoneFlag.HasIK))
                {
                    ...
                    for (int j = 0; j < countOfIKLinks; j++)
                    {
                        ...
                        {
                            var min = ReadVector3XYInv(reader);
                            var max = ReadVector3XYInv(reader);

                            boneIKLink.LimitMin.X = max.X;
                            boneIKLink.LimitMin.Y = max.Y;
                            boneIKLink.LimitMin.Z = min.Z;
                            boneIKLink.LimitMax.X = min.X;
                            boneIKLink.LimitMax.Y = min.Y;
                            boneIKLink.LimitMax.Z = max.Z;
                        }
                ...
                switch (morph.Type)
                {
                    ...
                    case PMX_MorphType.Vertex:
                        ...
                        for (int j = 0; j < countOfMorphData; j++)
                        {
                            ...
                            vertexStruct.Offset = ReadVector3ZInv(reader);
                            morph.MorphVertice[j] = vertexStruct;
                        }
                        Array.Sort(morph.MorphVertice, _morphVertexCmp);
                        break;
                    case PMX_MorphType.Bone:
                        ...
                        for (int j = 0; j < countOfMorphData; j++)
                        {
                            ...
                            morphBoneStruct.Translation = ReadVector3ZInv(reader);
                            morphBoneStruct.Rotation = ReadQuaternionXYInv(reader);
            ...
            for (int i = 0; i < countOfRigidBody; i++)
            {
                ...
                rigidBody.Position = ReadVector3ZInv(reader);
                rigidBody.Rotation = ReadVector3XYInv(reader);
                rigidBody.Mass = reader.ReadSingle();
                rigidBody.LinearDamp = reader.ReadSingle();
                rigidBody.AngularDamp = reader.ReadSingle();
            ...
            for (int i = 0; i < countOfJoint; i++)
            {
                ...
                joint.Position = ReadVector3ZInv(reader);
                joint.Rotation = ReadVector3XYInv(reader);
                ...
                joint.AngularSpring = ReadVector3(reader);
        ...
        private Vector3 ReadVector3ZInv(BinaryReader reader)
        {
            Vector3 vector3 = new Vector3();
            vector3.X = reader.ReadSingle();
            vector3.Y = reader.ReadSingle();
        ...
        private Vector3 ReadVector3XYInv(BinaryReader reader)
        {
            Vector3 vector3 = new Vector3();
            vector3.X = -reader.ReadSingle();
            vector3.Y = -reader.ReadSingle();
        ...
        private Quaternion ReadQuaternionXYInv(BinaryReader reader)
        {
