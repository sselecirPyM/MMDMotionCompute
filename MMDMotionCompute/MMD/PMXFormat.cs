...
namespace MMDMotionCompute.MMD
{
    ...
    public struct PMX_Texture
    {
        ...
        {
            return obj is PMX_Texture texture &&
                   TexturePath == texture.TexturePath;
        }

        public override int GetHashCode()
        {
            return HashCode.Combine(TexturePath);
        }
    ...
    public struct PMX_MorphSubMorphDesc
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is PMX_MorphSubMorphDesc desc &&
        ...
        public override int GetHashCode()
        {
            return HashCode.Combine(GroupIndex, Rate);
        }
    }
    public struct PMX_MorphUVDesc
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is PMX_MorphUVDesc desc &&
                   VertexIndex == desc.VertexIndex &&
                   Offset.Equals(desc.Offset);
        }

        public override int GetHashCode()
        {
            return HashCode.Combine(VertexIndex, Offset);
        }
    }
    ...
    public struct PMX_MorphMaterialDesc
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is PMX_MorphMaterialDesc desc &&
                   MaterialIndex == desc.MaterialIndex &&
                   MorphMethon == desc.MorphMethon &&
                   Diffuse.Equals(desc.Diffuse) &&
                   Specular.Equals(desc.Specular) &&
                   Ambient.Equals(desc.Ambient) &&
                   EdgeColor.Equals(desc.EdgeColor) &&
                   EdgeSize == desc.EdgeSize &&
                   Texture.Equals(desc.Texture) &&
                   SubTexture.Equals(desc.SubTexture) &&
                   ToonTexture.Equals(desc.ToonTexture);
        }
    ...
    public struct PMX_MorphVertexDesc
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is PMX_MorphVertexDesc desc &&
                   VertexIndex == desc.VertexIndex &&
                   Offset.Equals(desc.Offset);
        }
    ...
    public struct PMX_MorphBoneDesc
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is PMX_MorphBoneDesc desc &&
                   BoneIndex == desc.BoneIndex &&
                   Translation.Equals(desc.Translation) &&
                   Rotation.Equals(desc.Rotation);
        }

        public override int GetHashCode()
        {
            return HashCode.Combine(BoneIndex, Translation, Rotation);
        }
    }
    ...
    public struct PMX_EntryElement
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is PMX_EntryElement element &&
                   Type == element.Type &&
                   Index == element.Index;
        }
